...
Wait Until Location Contains In The Middle
    [Setup]    Go To Page "javascript/wait_location.html"
    Click Element   button
    Wait Until Location Contains     8080
...
Wait Until Location Is
    [Setup]    Go To Page "javascript/wait_location.html"
    Click Element   button
    Wait Until Location Is     http://localhost:8080/html/
...
Wait Until Location Is Not
    [Setup]    Go To Page "javascript/wait_location.html"
    Click Element   button
    Wait Until Location Is Not     http://localhost:8080/html/javascript/wait_location.html
...
Wait Until Location Is Not Fails With Timeout
    ...
    Run Keyword And Expect Error
    ...     *
    ...     Wait Until Location Is Not     http://localhost:8080/html/javascript/wait_location.html   timeout=750ms
    Set Selenium Timeout    ${orig_timeout}
...
Wait Until Location Is Not Fails With Message
    ...
    Run Keyword And Expect Error
    ...     *
    ...     Wait Until Location Is Not     http://localhost:8080/html/javascript/wait_location.html  message=my_message
    Set Selenium Timeout    ${orig_timeout}
...
Wait Until Location Does Not Contain Fail As Number
    ...
    Run Keyword And Expect Error
    ...    *
    ...    Wait Until Location Does Not Contain   ${8080}
    Set Selenium Timeout    ${orig_timeout}
